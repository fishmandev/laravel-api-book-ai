...
class PermissionServiceTest extends TestCase
{
     ...
     */
    public function testDefineGatesCreatesGatesForAllPermissions(): void
    {
        // Arrange
        Permission::create([
            'name' => 'books.list',
     ...
     */
    public function testDefineGatesSkipsWhenPermissionsTableDoesNotExist(): void
    {
        // Arrange
     ...
     */
    public function testGateAllowsAccessWhenUserHasPermission(): void
    {
        // Arrange
     ...
     */
    public function testGateDeniesAccessWhenUserDoesNotHavePermission(): void
    {
        // Arrange
        $user = User::factory()->create([
            'id' => 2,
     ...
     */
    public function testGateWorksCorrectlyWithMultiplePermissions(): void
    {
        // Arrange
        $user = User::factory()->create([
            'id' => 2,
     ...
     */
    public function testGateDeniesNonExistentPermission(): void
    {
        // Arrange
        $user = User::factory()->create([
            'id' => 2,
     ...
     */
    public function testGatesWorkWithUserHavingMultipleRoles(): void
    {
        // Arrange
        $user = User::factory()->create([
            'id' => 2,
     ...
     */
    public function testDefineGatesHandlesEmptyPermissionsTable(): void
    {
     ...
     */
    public function testGateClosureReceivesCorrectUserParameter(): void
    {
        // Arrange
     ...
     */
    public function testDefineGatesIsIdempotent(): void
    {
        // Arrange
        Permission::create([
            'name' => 'test.permission',
